...
#if type(actor.values[0][1])== dict:
#    for j in range(list(actor.values[0][1].values())[0],list(actor.values[0][1].values())[1]+1):
#        match=actor_data.loc[(actor_data['gender'] == actor.values[0][0]) & (actor_data["age"]==j)]

#print(match)
#match=actor_data.loc[(actor_data['gender'] == actor.values[0][0]) & (actor_data["age"]==actor.values[0][1])]
#print(match)

#i=((actor.values[0][1].values()))
#print(list(i))
